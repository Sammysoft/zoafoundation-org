...
export default function footer() {
    return (
        <div className={"Foot-Wrapper"} style={{display: 'flex', backgroundColor: 'black', fontSize: '0.8rem'}}>
            <div style={{flex: 1, padding: '8px', color: 'white', borderRightColor: 'white', borderRightWidth: '2px' }}>
                <p className="para-foot">You can follow us on each of these social handles</p>
